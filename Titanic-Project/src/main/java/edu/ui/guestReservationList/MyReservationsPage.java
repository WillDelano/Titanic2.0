...
<<<<<<< HEAD:Titanic-Project/src/main/java/edu/ui/reservationDetails/MyReservationsPage.java
            int test = Integer.parseInt(row);
=======
            int intRow = Integer.parseInt(row);
>>>>>>> main:Titanic-Project/src/main/java/edu/ui/guestReservationList/MyReservationsPage.java
